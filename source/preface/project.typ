...
To me, that period in the history of computing was the most interesting, as
the systems of the time were still quite simple, enough so as to allow the
owner to entirely understand how they would operate, yet make it into the
...
documentation, and rather up to the implementer's discretion.
