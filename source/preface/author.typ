...
I knew my passion was computer engineering ever since high school. Since then, 
I have been researching about the inner workings of computers and their
operating principles. Due to the immense complexity of modern computational systems,
the best introduction to the field has been looking at designs of the past, or, 
in other words, the field of "retrocomputing". The constraints in the designs
of that era were interesting to me, as well as being a source of influence in and of
themselves.
...
any formal experience or certification on the topic, and instead, I am self-taught.
Most of my knowledge about this topic had been acquired from online sources,
mostly Wikipedia and YouTube, and from direct assistance and guidance from
people I met online, primarily on Discord.
...
-	*Clamentos*: A member of ORE, he was the person that took time out of his
	...
	principles behind pipelining, cache memory and branch prediction better than
...
as useful as one would hope. Regardless, I was already trying to learn it myself
