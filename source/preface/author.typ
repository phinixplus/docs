...
I knew my passion was computer engineering ever since high school. Since
then, I have been researching about the inner workings of computers and their
operating principles. Due to the immense complexity of modern computational
systems, the best introduction to the field has been looking at designs of the
past, or, in other words, the field of "retrocomputing". The constraints in
the designs of that era were interesting to me, as well as being a source of
...
any formal experience or certification on the topic, and instead, I am
self-taught. Most of my knowledge about this topic had been acquired from
online sources, mostly Wikipedia and YouTube, and from direct assistance and
guidance from people I met online, primarily on Discord.
...
-	*James Sharman*: His advanced homebrew computer series captured the
	...
	topics in the field, such as pipelining and bus timings, and portrays
	the immense software development effort that follows a completed build.
...
-	*Clamentos*: A member of ORE, he was the person that took time out of his
	days to explain to a stranger on the internet, me, the operation of and the
	principles behind pipelining, cache memory and branch prediction better
	than any professor at my university could.
...
as useful as one would hope. Regardless, I was already trying to learn it
myself before I even took that lesson. And, as per my choice of the typesetting
